...
namespace CZ.CEEG.SrvCrm.SaleOfferSbmt
{
    /// <summary>
    /// BOS_CRM_SaleOffer 服务端 Submit
    /// </summary>
    [Description("BOS_CRM_SaleOffer 服务端 Submit")]
    [Kingdee.BOS.Util.HotUpdate]
    public class CZ_CEEG_SrvCrm_SaleOfferSbmt : AbstractOperationServicePlugIn
    {
        #region override
        ...
        private class OperValidator : AbstractValidator
        {
            ...
            {
                DataTable _dt;
                string _sql = "exec proc_cztyCrm_VadOffer @FCrmSOID='#FID#'";
                string _backM = "";
                string _backMsg = "";
        ...
        private void Act_DoAfterSubmit(DynamicObject o)
        {
            ...
            */
            ...
            string _sql = "exec proc_cztyCrm_RndOffer @FCrmSOID='" + _FID + "'";
